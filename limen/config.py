"""Configuration system for LIMEN.
...
class EnvironmentConfig:
    ...
    context_file: str = "contexts/xminigrid.md"
...
class LLMModelConfig:
    ...
    Each field defaults to None — when None, the value is inherited from the
    parent LLMConfig.
    """
...
class LLMConfig:
    ...
    OpenAI, OpenRouter, Together, Groq, Fireworks, Anthropic-via-proxy,
    Azure OpenAI, vLLM, Ollama, LM Studio, etc. Set `api_base` to the
    provider's endpoint and `api_key` to the credential (or leave unset
    and export the relevant env var, e.g. OPENAI_API_KEY).
    """

    api_base: str = "https://openrouter.ai/api/v1"
    api_key: Optional[str] = None  # None -> read from OPENAI_API_KEY env
